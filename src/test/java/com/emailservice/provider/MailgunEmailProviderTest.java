...
public class MailgunEmailProviderTest {
    ...
    @InjectMocks private MailgunEmailProvider provider;
    ...
    public void setup() throws IOException{
        inputStream = new CharSequenceInputStream("{\"id\":\"1000\",\"message\":\"message sent\"}", Charset.defaultCharset());
